        ...
        for path in sorted((ROOT / 'notebooks' / directory).glob('*.ipynb')):
            ...
            if tier != 'reading':
                ...
                gate = ('<!-- paper-first -->\n'
                    ...
                    f'**Read or revisit {links}.** Use the assigned first-pass sections in the guide; '
                    'if you already read them, return only to the relevant figure or claim. '
                    'Do this before the technical explanation below.\n\n'
                    f'**Motivation:** {assignment["motivation_question"]}\n\n'
                    'Write a two-sentence prediction and one thing you cannot yet explain. Ask your AI tutor to '
                    'locate evidence in the supplied paper and distinguish it from inference. A paper link motivates '
                    'this question; it does not mean the paper uses every method demonstrated here.\n\n'
                    '**After the experiment:** revisit your prediction in the '
                    '[evidence ledger](../../curriculum/coursework/EVIDENCE_LEDGER.md). Explain one mechanism '
                    'you now understand, cite a result from this notebook, and name a paper claim this exercise '
                    'still cannot test. Keep a small demonstration distinct from a reproduction of the study.\n'
                    '<!-- /paper-first -->')
                ...
                notebook['cells'].append({
                    ...
                    'source': ('### Return to the research question\n\n'
                        f'Reopen {links} and your initial two-sentence prediction. In your '
                        '[evidence ledger](../../curriculum/coursework/EVIDENCE_LEDGER.md):\n\n'
                        '1. Cite one output or diagnostic from this lesson and explain the transformation it demonstrates.\n'
                        '2. Revise one claim or question from the paper, with a figure/section locator. '
                        'State what this small exercise still cannot establish about the published result.\n'
